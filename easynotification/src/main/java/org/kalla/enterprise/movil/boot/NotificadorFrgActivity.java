...
public class NotificadorFrgActivity extends FragmentActivity {
    private static final String TAG = NotificadorFrgActivity.class.getSimpleName();
    ...
    public boolean EnviarMensaje(String Texto, String obj) {
        ...
        if (messenger != null) {
            ...
            try {
                ...
                Log.e(TAG, "EnviarMensaje fallo", e);
            }
        }
    ...
    public void stopServices() {
        if (sConn != null) {
            NotificadorFrgActivity.this.stopService(new Intent(this, ServiceBootSeratic.class));
            //NotificadorFrgActivity.this.unbindService(sConn);
        }
    }
